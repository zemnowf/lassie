		...
		if ($elementId > 0)
		{
			...
			if (!empty($recommendedData))
			{
				...
				if (!isset($arParams['DETAIL_SHOW_POPULAR']) || $arParams['DETAIL_SHOW_POPULAR'] != 'N')
				{
					...
					<div>
						<div data-entity="parent-container">
                            <h2 class="heading product-page__title" data-entity="header" data-showed="false" >
				...
				)
				{
					...
					<div>
						<div data-entity="parent-container">
                            <h2 class="heading product-page__title" ata-entity="header" data-showed="false">
                                <span class="heading__text"><?=GetMessage('CATALOG_VIEWED')?></span></h2>
